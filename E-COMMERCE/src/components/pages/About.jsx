  ...
  return (
    <div className='flex bg-[silver] h-[90vh]'>
        <div className="mx-20 my-24">
          ...
          <div className="">
            <p>Our goal here at  <span className='font-bold'>Emmzy stores</span> is to give you the best service <br /> you could ever imagine. Founded in 2008 the <span className='font-bold'>JOE'S AUTOS</span> has been <br /> consistence over the years bring cutomers the best they could possibly get on <br />here, we appreciate all those who have been sending in their reviews, it has <br /> helped us over these past years to know areas where we can work on so as <br /> to be able to satify users/customers.</p>
          </div>
          <div className="py-4">
